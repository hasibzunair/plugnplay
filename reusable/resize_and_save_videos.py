...
Usage: python resize_and_save_videos.py --source ./datasets/videos/ --dest ./datasets/resized_videos
"""
...
for vid_file in video_files:
    if vid_file.endswith(".MOV") or vid_file.endswith(".mp4"):
